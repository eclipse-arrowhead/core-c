 ...
 * libraries.
 *
 * @note What functions are concretely provided can be configured as described
 * in conf.h.
 */
...
/**
 * Allocates a @e page of memory, guaranteed to be at least @c AH_PSIZE bytes
 * large.
 *
...
/**
 * Releases referenced memory page, potentially making it possible for
