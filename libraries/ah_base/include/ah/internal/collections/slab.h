...
#define AH_I_SLAB_GEN_ALLOC(QUALIFIERS, NAME_PREFIX, BASE_TYPE, ENTRY_TYPE)        \
 QUALIFIERS ah_err_t NAME_PREFIX##_alloc(BASE_TYPE* allocator, ENTRY_TYPE** entry) \
 {                                                                                 \
...
#define AH_I_SLAB_GEN_FREE(QUALIFIERS, NAME_PREFIX, BASE_TYPE, ENTRY_TYPE)   \
 QUALIFIERS void NAME_PREFIX##_free(BASE_TYPE* allocator, ENTRY_TYPE* entry) \
 {                                                                           \
  ah_assert_if_debug(allocator != NULL);                                     \
  ah_assert_if_debug(entry != NULL);                                         \
                                                                             \
...
#define AH_I_SLAB_GEN_GROW(QUALIFIERS, NAME_PREFIX, BASE_TYPE, PAGE_TYPE, ENTRY_TYPE, PAGE_CAPACITY) \
 QUALIFIERS ah_err_t NAME_PREFIX##_grow(BASE_TYPE* allocator, ENTRY_TYPE* free_entry)                \
 {                                                                                                   \
  ah_assert_if_debug(allocator != NULL);                                                             \
                                                                                                     \
...
#define AH_I_SLAB_GEN_INIT(QUALIFIERS, NAME_PREFIX, BASE_TYPE, PAGE_TYPE, ENTRY_TYPE, PAGE_CAPACITY) \
 QUALIFIERS ah_err_t NAME_PREFIX##_init(BASE_TYPE* allocator, size_t initial_capacity)               \
 {                                                                                                   \
  ah_assert_if_debug(allocator != NULL);                                                             \
                                                                                                     \
...
#define AH_I_SLAB_GEN_TERM(QUALIFIERS, NAME_PREFIX, BASE_TYPE, PAGE_TYPE) \
 QUALIFIERS void NAME_PREFIX##_term(BASE_TYPE* allocator)                 \
 {                                                                        \
  ah_assert_if_debug(allocator != NULL);                                  \
                                                                          \
