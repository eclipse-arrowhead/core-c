...
ah_inline bool ah_ipaddr_v4_is_loopback(const ah_ipaddr_v4_t addr)
{
    return memcmp(addr.octets, ah_ipaddr_v4_loopback.octets, 4u) == 0;
}

ah_inline bool ah_ipaddr_v4_is_wildcard(const ah_ipaddr_v4_t addr)
{
    return memcmp(addr.octets, ah_ipaddr_v4_wildcard.octets, 4u) == 0;
}

ah_inline bool ah_ipaddr_v6_is_loopback(const ah_ipaddr_v6_t addr)
{
    return memcmp(addr.octets, ah_ipaddr_v6_loopback.octets, 16u) == 0;
}

ah_inline bool ah_ipaddr_v6_is_wildcard(const ah_ipaddr_v6_t addr)
{
