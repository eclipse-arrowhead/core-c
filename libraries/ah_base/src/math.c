...
#if defined(ah_gcc_add_overflow)
# define S_ADD_INT8(a, b, result)    ah_gcc_add_overflow((a), (b), (result))
# define S_ADD_INT16(a, b, result)   ah_gcc_add_overflow((a), (b), (result))
# define S_ADD_INT32(a, b, result)   ah_gcc_add_overflow((a), (b), (result))
# define S_ADD_INT64(a, b, result)   ah_gcc_add_overflow((a), (b), (result))
# define S_ADD_INTPTR(a, b, result)  ah_gcc_add_overflow((a), (b), (result))
# define S_ADD_SIZE(a, b, result)    ah_gcc_add_overflow((a), (b), (result))
# define S_ADD_UINT8(a, b, result)   ah_gcc_add_overflow((a), (b), (result))
# define S_ADD_UINT16(a, b, result)  ah_gcc_add_overflow((a), (b), (result))
# define S_ADD_UINT32(a, b, result)  ah_gcc_add_overflow((a), (b), (result))
# define S_ADD_UINT64(a, b, result)  ah_gcc_add_overflow((a), (b), (result))
# define S_ADD_UINTPTR(a, b, result) ah_gcc_add_overflow((a), (b), (result))
#elif AH_IS_WIN32
...
#if defined(ah_gcc_mul_overflow)
# define S_MUL_INT8(a, b, result)    ah_gcc_mul_overflow((a), (b), (result))
# define S_MUL_INT16(a, b, result)   ah_gcc_mul_overflow((a), (b), (result))
# define S_MUL_INT32(a, b, result)   ah_gcc_mul_overflow((a), (b), (result))
# define S_MUL_INT64(a, b, result)   ah_gcc_mul_overflow((a), (b), (result))
# define S_MUL_INTPTR(a, b, result)  ah_gcc_mul_overflow((a), (b), (result))
# define S_MUL_SIZE(a, b, result)    ah_gcc_mul_overflow((a), (b), (result))
# define S_MUL_UINT8(a, b, result)   ah_gcc_mul_overflow((a), (b), (result))
# define S_MUL_UINT16(a, b, result)  ah_gcc_mul_overflow((a), (b), (result))
# define S_MUL_UINT32(a, b, result)  ah_gcc_mul_overflow((a), (b), (result))
# define S_MUL_UINT64(a, b, result)  ah_gcc_mul_overflow((a), (b), (result))
# define S_MUL_UINTPTR(a, b, result) ah_gcc_mul_overflow((a), (b), (result))
#elif AH_IS_WIN32
...
#if defined(ah_gcc_sub_overflow)
# define S_SUB_INT8(a, b, result)    ah_gcc_sub_overflow((a), (b), (result))
# define S_SUB_INT16(a, b, result)   ah_gcc_sub_overflow((a), (b), (result))
# define S_SUB_INT32(a, b, result)   ah_gcc_sub_overflow((a), (b), (result))
# define S_SUB_INT64(a, b, result)   ah_gcc_sub_overflow((a), (b), (result))
# define S_SUB_INTPTR(a, b, result)  ah_gcc_sub_overflow((a), (b), (result))
# define S_SUB_SIZE(a, b, result)    ah_gcc_sub_overflow((a), (b), (result))
# define S_SUB_UINT8(a, b, result)   ah_gcc_sub_overflow((a), (b), (result))
# define S_SUB_UINT16(a, b, result)  ah_gcc_sub_overflow((a), (b), (result))
# define S_SUB_UINT32(a, b, result)  ah_gcc_sub_overflow((a), (b), (result))
# define S_SUB_UINT64(a, b, result)  ah_gcc_sub_overflow((a), (b), (result))
# define S_SUB_UINTPTR(a, b, result) ah_gcc_sub_overflow((a), (b), (result))
#elif AH_IS_WIN32
