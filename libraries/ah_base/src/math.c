...
S_GEN(ah_add_int8, int8_t, S_ADD_INT8)
S_GEN(ah_add_int16, int16_t, S_ADD_INT16)
...
S_GEN(ah_add_uint8, uint8_t, S_ADD_UINT8)
S_GEN(ah_add_uint16, uint16_t, S_ADD_UINT16)
...
S_GEN_DIV_SIGNED(ah_div_int8, int8_t, INT8_MIN)
S_GEN_DIV_SIGNED(ah_div_int16, int16_t, INT16_MIN)
...
S_GEN_DIV_UNSIGNED(ah_div_uint8, uint8_t)
S_GEN_DIV_UNSIGNED(ah_div_uint16, uint16_t)
...
S_GEN(ah_mul_int8, int8_t, S_MUL_INT8)
S_GEN(ah_mul_int16, int16_t, S_MUL_INT16)
...
S_GEN(ah_mul_uint8, uint8_t, S_MUL_UINT8)
S_GEN(ah_mul_uint16, uint16_t, S_MUL_UINT16)
...
S_GEN(ah_sub_int8, int8_t, S_SUB_INT8)
S_GEN(ah_sub_int16, int16_t, S_SUB_INT16)
...
S_GEN(ah_sub_uint8, uint8_t, S_SUB_UINT8)
S_GEN(ah_sub_uint16, uint16_t, S_SUB_UINT16)
