...
JavaScript engines, which made it highly accessible for web applications. The
JSON format is commonly used to encode payloads part of HTTP messages
(see include/ah/http.h) in the context of web services. It has become an
important interchange format in the Arrowhead ecosystem.
