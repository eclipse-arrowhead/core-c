 ...
 */
typedef void (*ah_mbedtls_on_handshake_done_cb)(ah_mbedtls_client_t* client, const mbedtls_x509_crt* peer_chain, ah_err_t err);
 ...
 *   <li>@ref AH_EINVAL - @a trans is invalid, as reported by ah_tcp_trans_is_valid().
